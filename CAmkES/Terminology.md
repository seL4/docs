...
:   control; uses thing t1; emits sig s1; dataport buffer b1;

}

component bar {

:   provides thing t2; consumes sig s2; dataport buffer b2;
...
:   
    ...
    :   component foo f; component bar b;

        connection RPC c1(from f.t1, to b.t2); connection Notification
        c2(from f.s1, to b.s2); connection SharedData c3(from f.b1, to
        b.b2);
