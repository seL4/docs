...
<img class="w-4/5 mx-auto dark:bg-white dark:p-4 dark:rounded-xl"
     src="VisualCAmkES_Layout_Example.png" alt="Example Output from VisualCAmkES">
...
<img class="dark:bg-white dark:p-4 dark:rounded-xl"
     src="VisualCAmkES_userButtons.png" alt="VisualCAmkES Corner UI buttons">
...
<img class="w-4/5 mx-auto dark:bg-white dark:p-4 dark:rounded-xl"
     src="VisualCAmkES_UML.png" alt="UML Diagram of VisualCAmkES">
